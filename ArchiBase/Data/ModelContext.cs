...
public class ModelContext : DbContext
{
    ...
    override protected void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //modelBuilder.Entity<Building>().HasMany(e => e.Cards).WithOne(e => e.Building).HasForeignKey(e => e.BuildingId);
        modelBuilder.Entity<Building>().HasOne(e => e.ActualCard).WithOne(e => e.Building).HasForeignKey<Building>(e => e.ActualCardId);
