...
namespace ArchiBase.Migrations
{
    ...
    [Migration("20241117172437_AddCardAddressView")]
    partial class AddCardAddressView
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArchiBase.Models.CardAddressMapping", b =>
                {
                    b.OwnsMany("ArchiBase.Models.NamedStreetAddress", "Addresses", b1 =>
                        {
                            b1.Property<Guid>("CardAddressMappingCardId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("CardAddressMappingCardId", "Id");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("CardAddressMappingCardId");
                        });
